...
@DisplayName("DiaScraper - Tests de Integración")
class DiaScraperIT {

    private DiaScraper scraper;

    @BeforeEach
    void setUp() {
        RestTemplate restTemplate = new RestTemplate();
        VtexCore vtexCore = new VtexCore(restTemplate);
        scraper = new DiaScraper(vtexCore);
    }

    @Test
    @DisplayName("getNombre() devuelve 'diaonline'")
    void getNombre_devuelveIdentificadorCorrecto() {
        assertThat(scraper.getNombre()).isEqualTo("diaonline");
    }
    ...
    void buscar_queryValida_devuelveResultados() {
        ...
        assertThat(resultados)
                .as("DIA debería devolver resultados para 'leche'")
                .isNotEmpty();
    }
    ...
    void buscar_todosLosProductosTienenCamposObligatorios() {
        ...
        assertThat(resultados).allSatisfy(p -> {
            ...
            assertThat(p.getSource()).as("source debe ser 'diaonline'").isEqualTo("diaonline");
    ...
    @Test
    @DisplayName("Todos los productos tienen link con el dominio de DIA")
    void buscar_productosConLinkValido() {
        ...
        assertThat(resultados)
                ...
                .allMatch(link -> link != null && link.contains("supermercadosdia.com.ar"),
                        "todos los links deben apuntar a supermercadosdia.com.ar");
    }
